...
public class OpenehrArchetype {
    ...
    public OpenehrArchetype(String archetypeFileName) {
        ...
        try {
            ...
            archetypeName = archetypeFileName.substring(0,archetypeFileName.length()-4);
            System.out.println("<"+archetypeName+"> loaded.");
    ...
    {
        OpenehrArchetype atUtil = new OpenehrArchetype("openehr/test/archetypes/openEHR-EHR-OBSERVATION.respiration.v1.adl");
...
//        System.out.println(atUtil.getItemCode("/data[at0001]/events[at0002]/data[at0003]/items[at0004]"));
        ...
        atUtil = new OpenehrArchetype("openehr/test/archetypes/openEHR-EHR-EVALUATION.problem.v1.adl");
