...
public class OpenEHR {
    ...
    public void testTraitOpenehr() {
        ...
        ArchetypeReference arRespiration = new ArchetypeReference("EHR","openehr/test/archetypes/openEHR-EHR-OBSERVATION.respiration.v1","","LAST");
        ...
        ArchetypeReference arDiagnosis = new ArchetypeReference("EHR","openehr/test/archetypes/openEHR-EHR-EVALUATION.problem-diagnosis.v1","","LAST");
